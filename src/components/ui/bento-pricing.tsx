  ...
  return (
    <div className="grid grid-cols-1 gap-1.5 md:grid-cols-2 lg:grid-cols-8">
      ...
      >
        ...
        <div className="flex flex-col p-3 lg:flex-row">
          ...
          <ul className="text-gray-300 grid gap-2 text-xs lg:w-[70%] font-open-sans-custom">
            {[
              "Доступ ко всем сообществам и дискуссиям",
              "Участие в закрытых мероприятиях",
              "Значок «Звезда» в профиле",
              "Расширенные инструменты для пранков и квизов",
            ].map((f, i) => (
              <li key={i} className="flex items-center gap-2">
                <Check className="w-[1.05rem] h-[1.05rem] text-white flex-shrink-0" strokeWidth={3} />
      ...
      <PricingCard
        ...
        features={[
          "Профиль и лента событий",
          "Участие в открытых дискуссиях",
          "Просмотр пранков и историй",
          "До 3 сообществ",
        ]}
      ...
      <PricingCard
        ...
        priceLabel="1 999 ₽"
        priceSuffix="/мес"
        features={["Все возможности «Мудреца»", "Выделенная страница организатора", "Монетизация мероприятий"]}
        className="lg:col-span-4"
        cta="Вступить"
      />

      <PricingCard
        titleBadge="ОРГАНИЗАЦИЯ"
        priceLabel="По запросу"
        priceSuffix=""
        features={[
          "Религиозные организации, фонды, НКО",
          "Верифицированный аккаунт",
          "Приоритетная поддержка",
          "Корпоративные инструменты для событий",
        ]}
